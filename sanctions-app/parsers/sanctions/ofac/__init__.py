...
class OfacSanctionsParser(SanctionsParser):
    ...
    def parse_xml_tree():
        ...
        try:
            ...
            raise Exception("US sanctions source file 'consolidated-US.xml' not found in data/source_files")
...
class OfacSdnParser(SanctionsParser):
